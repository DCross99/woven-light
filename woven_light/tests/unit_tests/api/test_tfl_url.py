...
from woven_light.api.tfl_url import base_tfl_url, VALID_LINES
...
@pytest.mark.parametrize(
    ...
    [(["bakerloo"], ["bakerloo"]), (["victoria", "central"], ["victoria", "central"])],
)
...
@pytest.mark.parametrize(
    "input_lines", [(["OH_NO_INVALID_LINE"]), (["victoria", "CeNtRal"])]
)
